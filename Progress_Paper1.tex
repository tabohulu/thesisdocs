...
\title{
A Novel Method for Obtaining the Structure and Corresponding Parity Weight Equations for the RTZ Inputs of RSC Codes: A First Step Towards Interleaver Design}
...
\include{./PaperSources/Preliminaries}
