...
\maketitle
\input{./PaperSources/Abstract}
\input{./PaperSources/Introduction}
\input{./PaperSources/Preliminaries}
\input{./PaperSources/RSCReview}
%\input{./PaperSources/TransferFunction}
\input{./PaperSources/NovelMethod}
\input{./PaperSources/SimulationResults}
\input{./PaperSources/Conclusion}
\input{./PaperSources/References}
